...
func TestBase(t *testing.T) {
	...
	evalResult1, err := transactionOut.ApplyOperator(NewAvgTicketAnalyzer("avg ticket analyzer", 2, NewCarFiledStrategy()))

	evalResult2, err := transactionOut.ApplyOperator(NewWindowedProximityAnalyzer("windowed proximity analyzer", 2, NewCarFiledStrategy()))

	evalResult3, err := transactionOut.ApplyOperator(NewWindowedTransactionCountAnalyzer("windowed transaction count analyzer", 2, NewCarFiledStrategy()))
